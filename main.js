...
//         //add event listenser
    ...
    const barchart_margin = {top:80, right:40, bottom:40,left:200};
   ...
   // let xMax = d3.max(barChartData, d=> d.revenue);
    ...
    function mouseover(e){
        ...
        const bodyData = [
           ...
           ['GDP per capita', Math.round(thisBarData.GDP_per_capita)],
        ...
        //show this data
        tip.select('h3').html(`${thisBarData.Country}, No.${thisBarData.Rank}`);
